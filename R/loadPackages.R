...
function(packages=NULL
        ...
        #' @description 
        #' Checks which packages are installed, and installs the missing ones from CRAN and BioConductor.
		#' After that, all packages are loaded.
        #' @param packages Character vector of packages to be loaded/installed.
        #' @param popup Show a popup notification upon successful package loading?
